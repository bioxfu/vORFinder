  ...
  dashboardBody(
    tabItems(
      tabItem(tabName = "makedatabase",
              ...
              box(
                width = 12,
                img(src = "workflow.png", height = "600px", width = "900px")
              )
      ),
      tabItem(tabName = "uploadfiles",
              ...
              fluidRow(
                box(width = 12,
                    ...
                    conditionalPanel(condition = "$('html').hasClass('shiny-busy')", img(src = "giphy.gif"))
                ),
      ...
      tabItem(tabName = "blast",
              ...
              fluidRow(
                column(8, textInput("evalue","Expectation value (E) threshold for BLAST:", "1e-10")),
                box(width = 8, collapsible = T, tableOutput("blastp"))
              )
      ),
      tabItem(tabName = "cal",
              h3("Calculate"),
